  ...
  return (
    ...
    <CardWrapper>
      ...
      <CardBody>
        ...
        <CardTitle tag="h2">After internal 'panic', Google is rushing to unveil a new AI-powered search engine to compete with Microsoft </CardTitle>
        <CardActions>
          <CardAvatar src="https://i.pravatar.cc/300" height={60} width={60} alt="user avatar" />
		<CardRightAction>
			...
			<Tooltip color="primary" message="Like">
				<CardActionIcon onClick={onLikePost}>
					{isLike ? (<AiTwotoneLike tw="text-primary" size={18} />) : (<AiOutlineLike size={18} />)}
					<span>45</span>
				</CardActionIcon>
			</Tooltip>
		</CardRightAction>
...
const CardWrapper = tw(Card)`border border-gray-700 hover:border-primary transition duration-500 ease-in-out cursor-pointer`
...
const CardActions = tw(Card.Actions)`flex justify-between items-center gap-3 mt-4`;
